...
<div class="max-w-2xl mx-auto">
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold font-outfit text-slate-800">Tambah Alumni</h1>
            <p class="text-slate-400 mt-1">Masukkan data master alumni untuk mulai melacak.</p>
        </div>
    ...
    <div class="bg-white rounded-[2rem] shadow-premium border border-slate-100 p-10">
        <form action="{{ route('alumni.store') }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div class="group">
                    ...
                    <input type="number" name="graduation_year" id="graduation_year" value="{{ old('graduation_year', date('Y')) }}" 
                        class="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-4 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all text-slate-800 font-medium placeholder:text-slate-300"
                        required>
            ...
            <div class="pt-4">
                <button type="submit" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-4 rounded-2xl font-bold text-lg shadow-lg shadow-indigo-600/30 transition-all flex items-center justify-center space-x-3 group">
                    <span>Simpan & Daftarkan Alumni</span>
